...
const SignUp = () => {
    ...
    const signUp = (e) => {
        ...
        .then((userCredential) => {
                ...
                //successfull redirect to home
            }).catch((error) => {
                alert("Account already created, Login.");
                if (error === "FirebaseError: Firebase: Error (auth/email-already-in-use).") navigate("/signIn");
    ...
    <form onSubmit={signUp}>
        <div className='px-8 py-8'>
            ...
            <div className='items-center justify-center h-14 w-full my-4 space-x-4 pt-4'>
                <button type='submit' className='w-full rounded text-white font-semibold bg-green-400 py-2 px-2 hover:bg-green-700'>Sign Up</button>
            </div>
        </div>
    </form>
    </div>
